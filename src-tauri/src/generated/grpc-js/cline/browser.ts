...
export const BrowserServiceService = {
  ...
  updateBrowserSettings: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: UpdateBrowserSettingsRequest): Buffer =>
      Buffer.from(UpdateBrowserSettingsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): UpdateBrowserSettingsRequest => UpdateBrowserSettingsRequest.decode(value),
