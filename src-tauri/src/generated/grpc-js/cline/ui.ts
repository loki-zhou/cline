...
export const UiServiceService = {
  ...
  subscribeToMcpButtonClicked: {
    ...
    requestStream: false,
    responseStream: true,
    requestSerialize: (value: WebviewProviderTypeRequest): Buffer =>
      Buffer.from(WebviewProviderTypeRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): WebviewProviderTypeRequest => WebviewProviderTypeRequest.decode(value),
