...
export const StateServiceService = {
  ...
  updateDefaultTerminalProfile: {
    ...
    responseSerialize: (value: TerminalProfileUpdateResponse): Buffer =>
      Buffer.from(TerminalProfileUpdateResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): TerminalProfileUpdateResponse => TerminalProfileUpdateResponse.decode(value),
  },
  getAvailableTerminalProfiles: {
