...
export const WatchServiceService = {
  ...
  subscribeToFile: {
    ...
    requestStream: false,
    responseStream: true,
    requestSerialize: (value: SubscribeToFileRequest): Buffer =>
      Buffer.from(SubscribeToFileRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): SubscribeToFileRequest => SubscribeToFileRequest.decode(value),
    responseSerialize: (value: FileChangeEvent): Buffer => Buffer.from(FileChangeEvent.encode(value).finish()),
    responseDeserialize: (value: Buffer): FileChangeEvent => FileChangeEvent.decode(value),
  },
} as const;
